...
class FullAttention(nn.Module):
    def __init__(self,embed=False, mask_flag=True, factor=5, scale=None, attention_dropout=0.1, output_attention=False):
...
class LambdaModule(nn.Module):
    def __init__(self,embed=False, mask_flag=True, factor=5, attention_dropout=0.1, output_attention=False):
